...
1. **Enumerates root ray pairs** for periods $n = 2, 3, 4, 5, 7$ using the shortest-chord criterion on orbit portraits
...
```
@article{marashdeh2026mandelbrot,
  title={Canonical Hypergroups from External Angles of the {M}andelbrot Set},
